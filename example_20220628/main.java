...
public class main {
    ...
    public static void CreateSlime() {
        ...
        actionSlimeBludslime blueSlime = new actionSlimeBludslime();
        actionSlimeRedslime redSlime = new actionSlimeRedslime();

        normalSlime.getAction(blueSlime);
        normalSlime.getAction(redSlime);
